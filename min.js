/* requirements: 
 * fill out the contents of the min function with code that returns the smallest value in numbers
 * JavaScript has a Math.min function available, but do NOT use it in this exercise; 
 * instead, you will need to use your knowledge of arrays, loops and variables.
 */
